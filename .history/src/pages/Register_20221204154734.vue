  ...
  <div class="loginWrapper">
		<div class="login">
			...
			<div class="login_box">
				...
				<!-- 可以简写为required -->
				<input type="text" v-model.trim="userName" required /><label>用户名</label>
			</div>
			<div class="login_box">
				<input type="password" v-model="password" required="required" /><label>密码</label>
			</div>
			<div class="login_box">
				<input type="password" v-model="pwdConfirm" required="required" /><label>确认密码</label>
			</div>
            <div>
...
export default {
    ...
    methods:{
        ...
        doRegister(){
			...
			//  this.$route.push('/')
			console.log(JSON.parse(localStorage.getItem('save'))[0]);
